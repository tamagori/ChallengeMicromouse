			...
			case 2:
				...
				*****************************************/	
				...
				if(sen_fr.value + sen_fl.value + sen_r.value + sen_l.value > SEN_DECISION * 4){
					...
					log_timer = 0;
					len_mouse = 0;
					straight(5*SECTION,SEARCH_ACCEL,SEARCH_SPEED,0);
					log_flag = 0;
					MOT_POWER_OFF;
					wait_ms(1000);
					BEEP();
			...
			case 4:
				...
				*****************************************/
				...
				if(sen_fr.value + sen_fl.value + sen_r.value + sen_l.value > SEN_DECISION * 4){
					...
					{
						len_mouse = 0.F;
						straight(SECTION,SEARCH_ACCEL,SEARCH_SPEED,0.F);
					}
					log_flag = 0;
					MOT_POWER_OFF;
					BEEP();
			...
			case 5:
				...
				*****************************************/
				...
				if(sen_fr.value + sen_r.value > SEN_DECISION * 2){
					...
					log_timer = 0;
					len_mouse = 0;
					straight(SECTION,SEARCH_ACCEL,SEARCH_SPEED,SEARCH_SLA_SPEED);			//1区画直進
					...
					straight(SECTION,SEARCH_ACCEL,SEARCH_SLA_SPEED,0);						//1区画直進
					log_flag = 0;
					MOT_POWER_OFF;
					wait_ms(1000);
					BEEP();
