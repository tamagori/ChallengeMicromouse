...
void clock_init(void){
	...
	SYSTEM.PLLWTCR.BYTE     = 0x0F;		/* 4194304cycle(Default) *//* 約21.85ms */
...
void sensor_init(void){
	...
	S12AD.ADANS0.WORD = 0x0047;	//A/D変換をAN006,AN002,AN001,AN000を許可する
...
void init_parameters(void)
{
	...
	con_fwall.kp = FL_WALL_KP/10000.0;			//前壁比例制御の比例定数を初期化
}
